...
export default function Home() {
  ...
  const [activeTab, setActiveTab] = useState<'html' | 'css' | 'swift'>('html');
    ...
    <main className="min-h-screen">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <p className="mt-2 text-gray-600">
            Convert Figma designs to HTML/CSS and SwiftUI code
          </p>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Paste your Figma file URL above. The code will be generated automatically.
          </p>
        </div>
      </section>
      ...
      <footer className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-center text-sm text-gray-500">
          Built with Figma API • Generates HTML/CSS and SwiftUI code
        </p>
      </footer>
    </main>
  );
